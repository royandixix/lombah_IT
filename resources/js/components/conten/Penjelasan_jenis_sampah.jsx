...
export default function Example() {
    ...
    // Ambil semua gambar dari semua kategori
    const allImages = data.flatMap((item) => item.images);

    // Ganti gambar besar tiap 3 detik
    useEffect(() => {
            ...
            >
                <div
                    className="lg:col-span-2 lg:col-start-1 lg:row-start-1 
                        lg:mx-auto lg:grid lg:w-full lg:max-w-7xl 
                    ...
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            ...
                            <h1 className="mt-2 text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
                                Sampah yang Bisa{" "}
                                <span className=" text-green-600">Didaur</span>{" "}
                                Ulang
                            </h1>
                            <p className="mt-6 text-xl leading-8 text-gray-700">
                                Banyak jenis sampah rumah tangga bisa
                                dimanfaatkan kembali jika dipilah dengan benar.
                                Mari kenali beberapa contohnya agar lebih mudah
                                mendaur ulang.
                            </p>
                        </div>
                    </div>
                ...
                <div
                    className="-mt-12 -ml-12 p-12 
                        lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 
                ...
                >
                    <div className="lg:pr-4">
                        <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                            <ul
                                role="list"
                                className="mt-8 space-y-8 text-gray-700"
                            >
                                {data.map((item, idx) => (
                                    <li
                                        key={idx}
